...
db_user=wolflea
db_user_pass=jlg5NcJgemwRQuyWFqJN
...
find . -type f -name 'app.conf' -exec sed -i -r 's/db.username=/db.username='$db_user'/g' {} \;
find . -type f -name 'app.conf' -exec sed -i -r 's/db.password=/db.password='$db_user_pass'/g' {} \;
find . -type f -name 'app.conf' -exec sed -i -r 's/V85ZzBeTnzpsHyjQX4zukbQ8qqtju9y2aDM55VWxAH9Qop19poekx3xkcDVvrD0y/KpbGp6CDmUKe9mhOzYKkxxI3KyaTI7epsllGogkNLHcRvJ4lQr7fJYRfKcVrFqnC/g' {} \;
